%% 1. Clear Workspace and Define Specifications
clear; clc; close all;
...
%% 2. Estimate Filter Order using firpmord
...
%% 3. Design the FIR Filter using firpm (Parks-McClellan)
...
%% 5. Plotting the Filter Response
figure;
subplot(2,1,1);
...
%% 6. Coefficient Quantization (Fixed-Point)
...
%% 7. Write Fixed-Point Coefficients to a Text File (for Verilog)
